...
class ContrastiveModel(torch.nn.Module):
    ...
    def forward(self, original_input_ids=None, original_attention_mask=None, translation_input_ids=None, translation_attention_mask=None):
        ...
        original_encoded = torch.nn.ReLU()(self.original_norm(self.original_linear(torch.flatten(original_attention, start_dim=1))))
        translation_encoded = torch.nn.ReLU()(self.translation_norm(self.translation_linear(torch.flatten(translation_attention, start_dim=1))))
